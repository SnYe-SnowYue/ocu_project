...
SQL_FILES = (
    ...
    ROOT_DIR / "database" / "seed" / "stock_mappings.sql",
    ROOT_DIR / "database" / "backup" / "ocu_project_2025_1230.sql",
)
...
def main() -> int:
    try:
        ...
        _execute_sql_files()
        print("[init_db] 完成：資料庫、基礎資料與示範帳號已準備好。")
        print("[init_db] 示範帳號：demo / demo123")
        return 0
    except pymysql.MySQLError as exc:
