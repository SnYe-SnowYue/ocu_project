...
CREATE TABLE IF NOT EXISTS stock_sectors (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_stock_sectors_name (sector_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS stock_name_map (
    ...
    stock_ticker VARCHAR(32) NULL,
    sector_id INT NULL,
    PRIMARY KEY (id),
    UNIQUE KEY uk_stock_name_map_name_en (name_en),
    KEY idx_stock_name_map_sector_id (sector_id),
    KEY idx_stock_name_map_stock_ticker (stock_ticker),
    CONSTRAINT fk_stock_name_map_sector FOREIGN KEY (sector_id) REFERENCES stock_sectors (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
